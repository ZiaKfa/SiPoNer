  ...
  <div class="row">
    ...
    <div class ="row">
        <div class="col text-left">
            <a href="<?= base_url('pokemon/create'); ?>" class="btn btn-primary">Add Pokemon</a>
        </div>
    </div>
    <table class="table">
    <thead>
    ...
    <tbody>
        ...
        <tr>
            ...
            <div class="btn-group" role="group">
              <a href="<?= base_url('pokemon/edit/' . $p['id']); ?>" class="btn btn-sm btn-warning">Edit</a>
              <a href="<?= base_url('pokemon/delete/' . $p['id']); ?>" class="btn btn-sm btn-danger">Delete</a>
            </div>
            </td>
        </tr>
        <?php endforeach; ?>
